...
// Who is converting this code? - Babel - A javascript compiler.

// if you want to give any attributes to JSX, you have to use camelcase.
const jsxHeading = <h1 id="heading" className="heading-tag">Namaste React using JSX.</h1>;
